    ...
    return (
      <div className="empty__shoppingcart">
        <div className="wrapper">
          ...
          <img
            src="\images\fineASSDOGGO.jpg"
            alt="This is fine meme with plants"
          />
        </div>
      </div>
    )
                ...
                <td className="cart__quantitybuttons">
                  <span>
                    <IconButton
                      id="itembutton"
                      onClick={() => {
                        changeQuantity('decrement', product.id, 1)
                      }}
                    >
                      <RemoveIcon />
                    </IconButton>
                    ...
                    <IconButton
                      id="itembutton"
                      onClick={() => {
                        changeQuantity('increment', product.id, 1)
                      }}
                    >
                      <AddIcon />
                    </IconButton>
